...
#define SERURO_IMAGE_LIST_WIDTH   15
#define SERURO_IMAGE_LIST_HEIGHT  12
#else
#define SERURO_APP_DEFAULT_WIDTH  600
#define SERURO_SETUP_WIDTH		  400
#define SERURO_IMAGE_LIST_WIDTH   12
#define SERURO_IMAGE_LIST_HEIGHT  12
#endif
...
#define DEFAULT_SIZER_OPTIONS wxSizerFlags().Expand().Border(wxALL, 5)
#define DEFAULT_BOXSIZER_OPTIONS wxSizerFlags().Expand().Border(wxBOTTOM)
#define DEFAULT_BUTTONS_OPTIONS wxSizerFlags().Right().Expand()
#define DEFAULT_BOXSIZER_SIZER_OPTIONS wxSizerFlags().Expand().Border(wxTOP | wxRIGHT | wxLEFT, 5)

#define SETTINGS_PANEL_SIZER_OPTIONS DEFAULT_SIZER_OPTIONS
#define SETTINGS_PANEL_BOXSIZER_OPTIONS DEFAULT_BOXSIZER_OPTIONS
#define SETTINGS_PANEL_BUTTONS_OPTIONS DEFAULT_BUTTONS_OPTIONS

#define DIALOGS_SIZER_OPTIONS wxSizerFlags().Expand().Border(wxALL, 10)
#define DIALOGS_BOXSIZER_OPTIONS DEFAULT_BOXSIZER_OPTIONS
#define DIALOGS_BOXSIZER_SIZER_OPTIONS wxSizerFlags().Expand().Border(wxTOP | wxRIGHT | wxLEFT, 10)
#define DIALOGS_BUTTONS_OPTIONS wxSizerFlags().Right().Expand().Border(wxALL, 5)
