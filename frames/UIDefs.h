...
#define DIALOGS_SIZER_OPTIONS SETTINGS_PANEL_SIZER_OPTIONS.Border(wxALL, 15)
#define DIALOGS_BOXSIZER_OPTIONS SETTINGS_PANEL_BOXSIZER_OPTIONS
#define DIALOGS_BOXSIZER_SIZER_OPTIONS DEFAULT_BOXSIZER_SIZER_OPTIONS
#define DIALOGS_BUTTONS_OPTIONS DEFAULT_BUTTONS_OPTIONS.Border(wxALL, 5)
